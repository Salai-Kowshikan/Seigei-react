        ...
        <>
            ...
            <div className="flex flex-col sm:flex-row justify-around items-center h-[85vh]">
                ...
                <div className="flex-[1] flex flex-col justify-around items-center h-full">
                    ...
                    <div className="flex-1 flex w-[70%] justify-around">
                    ...
                    <button className="flex-1 w-[70%] border-none rounded-[10px] font-inter text-[20px] font-bold mx-1 mb-4 cursor-pointer">
                        Meet code
                    </button>
